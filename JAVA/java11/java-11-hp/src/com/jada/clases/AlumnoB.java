...
public void mostrarDatos() {
    	System.out.println(this.getNombre()+" "+this.getEdad()+" "+this.getMatriculas()+" "+this.getPromedio());

}

public void mostrarDatos(String apellido) {
	System.out.println(this.getNombre()+" "+apellido+" "+this.getEdad()+" "+this.getMatriculas()+" "+this.getPromedio());
